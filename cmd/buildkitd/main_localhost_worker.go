...
import (
	...
	"github.com/moby/buildkit/worker/localhost"
...
func localhostWorkerInitializer(c *cli.Context, common workerInitializerOpt) ([]worker.Worker, error) {
	...
	//}
	opt, err := localhost.NewWorkerOpt(common.config.Root, snapshotter)
	if err != nil {
		return nil, err
	}
